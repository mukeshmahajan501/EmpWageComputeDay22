...
public class EmpWageBuilderUc8
{
      ...
      public static  int EMP_RATE_PER_HOUR;
		...
		public EmpWageBuilderUc8(String company,int empRate,int workingHrs,int maxHrs)
		{
			empCompany=company;
...
public static void main(String args[])
	{
		...
		EmpWageBuilderUc8 emp=new EmpWageBuilderUc8("DMART",20,20,100);
		emp.calculateEmpWage();
		EmpWageBuilderUc8 emp1=new EmpWageBuilderUc8("Relince",30,20,100);
